...
if __name__ == '__main__':
    ...
    refreshDelay = 0
    while True:
        refreshDelay = input("\nWhat refresh delay would you like? NOTE: Enter in terms of seconds. You can use decimals.\n")
        try:
            float(refreshDelay)
            break
        except ValueError:
            print('\nInvalid value. Enter as a number. Ex: "2" for two seconds.')
            pass
    ...
    while True:
        try:
            driver.find_element_by_xpath('//*[@id="3070-staticprice"]')
